...
from keyboards.inline_kb.kb_create.kb_start import kb_start
from keyboards.inline_kb.select_kb import select_kb, select_delete_kb
...
async def get_start(message: Message):
    ...
    if chat_id in allowed_chat_ids:
        await message.answer(f"Привет{message.from_user.full_name}, в меню выбери комманду."
...
async def get_delete(message: Message):
    await message.answer("какую таблицу удалить:", reply_markup=select_delete_kb())
